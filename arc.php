...
<div class="main-body">
	<div class="container-fluid  card">
		...
		<p>Any conduct by any student or students whether by words spoken or written or by an act which has the effect of
			teasing, treating or handling with rudeness a fresher or any other student;<br>
			...
			of such fresher or any other student;<br>
			Any act by a senior student that prevents, disrupts or disturbs the regular academic activity of any other student
			or a fresher;
			</p>
			<p>			Exploiting the services of a fresher or any other student for completing the academic tasks assigned to an
			...
			obscene and lewd acts, gestures, causing bodily harm or any other danger to health or person;<br>
			...
			any other student;
			Any act that affects the mental health and self-confidence of a fresher or any other student with or without an
			intent to derive a sadistic pleasure or showing off power, authority or superiority by a student over any fresher or
			any other student.</p>
<br>
			<strong>Actions to be taken against students for indulging and abetting ragging in technical
				institutions/Universities including Deemed to be University imparting technical education</strong><br>

				<p>	The punishment to be meted out to the persons indulged in ragging has to be exemplary and justifiably harsh to act
			...
			institutional authorities with the local police authorities.</p>
	<p></p>
			...
			of ragging at the institution level shall be any one or any combination of the following,<br><br>
